...
#     # NOTE: st.set_page_config() is NOT called here; it's set once in the main
#     # entry script (NAF_NAF_Solution_Wizard.py). Calling it on every page can
#     # cause Streamlit to reset widget-bound session state keys on navigation.
...
#         )
#
#         # DEBUG: Show current state of key wizard fields
#         with st.expander("[DEBUG] Session State Check", expanded=False):
#             st.write("automation_title in session_state:", "automation_title" in st.session_state)
#             st.write("automation_title value:", st.session_state.get("automation_title", "(not set)"))
#             st.write("use_cases count:", len(st.session_state.get("use_cases", [])))
#
